...
- On [Developer Tools/services](https://my.home-assistant.io/redirect//developer-tools/) page tape "shell_command.random_responses", press CALL SERVICE and check if the script is executed.
